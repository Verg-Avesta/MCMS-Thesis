...
\subsubsection{Robustness Score}
	...
	In summary, we define robustness score $RS$ to be:
	$$RS = 0.5C + 0.5\lambda_{1}$$
\subsubsection{Flexibility Score}
	...
	In summary, we choose the inverse of the average shortest path $\frac{1}{d}$ to be the score of flexibility $FS$,that is to say:
	$$FS = \frac{1}{d}$$
